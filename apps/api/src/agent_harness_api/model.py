...
def system_prompt(final_response: bool) -> str:
    ...
    return (
        ...
        "Never print XML-like <tool_call> markup to invoke a tool; make a structured function call instead. "
        ...
        "Do not claim an edit or a passing check until its tool result confirms it. "
